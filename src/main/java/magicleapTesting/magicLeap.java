...
public class magicLeap {
    ...
    public String gridURL = "poc-hub.lambdatest.com"; //hub-virginia.lambdatest.com/wd/hub"@eu-central-1-hub.lambdatest.com/wd/hub";
    String status;
        ...
        for (int i = 0; i < 10; i++) {
            for (int j = 0; j < 5; j++) {
                try {
                    ...
                    capabilities.setCapability("build", "POC HUB Jenkins"+"  " + formatter.format(date) + "  " + this.PlatformValue +"  "+ System.getProperty("BUILD_NUMBER"));
